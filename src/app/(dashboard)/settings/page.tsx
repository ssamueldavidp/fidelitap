...
export default async function SettingsPage({
  ...
  const { data: business } = await supabase
    .from('businesses')
    .select('id, name, plan, stamp_cooldown_seconds, address, latitude, longitude')
    .eq('owner_id', user.id)
    .single() as { data: { id: string; name: string; plan: string; stamp_cooldown_seconds: number; address: string | null; latitude: number | null; longitude: number | null } | null; error: unknown }
